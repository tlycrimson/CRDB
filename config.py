class Config:
    ...
    HIGH_COMMAND_ROLE_ID = 1489697639833276548 
    BG_CHECKER_ROLE_ID = 1489697575979319526
    DB_LOGGER_ROLE_ID = 1489697573383176373  
    LA_ROLE_ID = 1489697345762496562 
    HR_ROLE_ID = 1489697587500945590
    RMP_ROLE_ID = 1489697451546902619
    CSM_ROLE_ID = 1489697580148457533
    TRACKED_REACTIONS = {"✅", "❌", "☑️", "🟢", "🔴", "<:green:1168511080746729512>", "<:red:1168511120949121115>"}
    W_EVENT_LOG_CHANNEL_ID = 1489697789192437823
    EVENT_LOG_CHANNEL_ID = 1489697784775835699
    PHASE_LOG_CHANNEL_ID = 1489697813083455740
    TRYOUT_LOG_CHANNEL_ID = 1489697815419556000
    COURSE_LOG_CHANNEL_ID  = 1489712630343008429
    ACTIVITY_LOG_CHANNEL_ID = 1489697893232414820
    TC_SUPERVISION_CHANNEL_ID = 1489697822688415858
    B_LOG_CHANNEL_ID =  1489697917894922380
    D_LOG_CHANNEL_ID = 1489697914266845254
    PUBLIC_CHAT_CHANNEL_ID = 1489690269057155235
    MAIN_COMMS_CHANNEL_ID = 1489697853512225046 
    LA_INDUCTION_CHANNEL_ID = 1493343908850307263
    HR_CHAT_CHANNEL_ID = 1489697937612345375
    SC_LOGS_CHANNEL_ID =1489697722490556426
    DSPG_GRADES_CHANNEL_ID = 1489697810797564155
    DEGREE_GRADES_CHANNEL_ID = 1489697831160643844
    COURSE_GRADES_CHANNEL_ID = 1493431064511905842
    INDOC_CHANNEL_ID = 1489697895971160175
    CASE_LOGS_CHANNEL_ID = 1493577875129892935
    SC_CHANNEL_ID = 1489697719797940244
    LD_CHANNEL_ID = 1489697861661626499
    DISCHARGE_REQUEST_CHANNEL_ID = 1489697910835646475
    ...
    DEFAULT_LOG_CHANNEL = 1489697977038799108
    IGNORED_CHANNELS = { 
        1165368317532438639,
        1165368316970405910,
        1165368313925353577,
    ...
    # ===== DIVISION & RANK ROLES =====
    # Division Roles
    PW_ROLE_ID = 1489697463446012067

    # HQ Role
    HQ_ROLE_ID = 1489697660683157655 

    # ===== PW HR RANKS (Highest to Lowest) =====
    PM_ROLE_ID = 1489697653536198856 
    PW_COMMANDER_ROLE_ID = 1489697646900674620
    PW_EXECUTIVE_ROLE_ID = 1489697642509242500
    LIEUTENANT_COLONEL_ROLE_ID = 1489697612281155766
    MAJOR_ROLE_ID = 1489697605377065110
    SUPERINTENDENT_ROLE_ID = 1489697600696225843
    CHIEF_INSPECTOR_ROLE_ID = 1489697595789152469
    INSPECTOR_ROLE_ID = 1489697590521102396
    PW_HR_IDS = {
        PM_ROLE_ID,
    ...
    RSM_ROLE_ID = 1489697610305634485  
    COMPANY_SERGEANT_MAJOR_ROLE_ID = 1489697580148457533
    STAFF_SERGEANT_ROLE_ID = 1489697502755029082
    SERGEANT_ROLE_ID = 1489697500607545626
    SENIOR_CONSTABLE_ROLE_ID = 1489697498225447213
    CONSTABLE_ROLE_ID = 1489697495121527105
    TRAINEE_CONSTABLE_ROLE_ID = 1489697476037312572  
    PW_LR_IDS = {
        RSM_ROLE_ID,
